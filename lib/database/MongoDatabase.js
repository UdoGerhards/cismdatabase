      ...
      },
      {
        ...
        $lookup: {
          ...
          pipeline: [
            ...
            // 🔗 question joinen
            {
              $lookup: {
                ...
                pipeline: [
                  ...
                  // 🔗 ALLE Antworten zur Frage holen
                  {
                    $lookup: {
                      from: "answer",
                      let: {
                  ...
                  // 📦 Question-Objekt erweitern
                  {
                    $project: {
                      _id: 1, // ✅ behalten
                      question: 1, // ✅ Fragetext
                      answers: 1,
                      correct: 1,
                    },
                  },
            ...
            {
              $project: {
                correct: 1, // boolean aus test_answer
                question: 1,
              },
            },
          ],
